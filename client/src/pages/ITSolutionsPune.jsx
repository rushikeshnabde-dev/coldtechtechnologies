...
const SCHEMA = {
  ...
  "@type": "Service",
  "name": "IT Solutions & Computer Repair in Pune — Coldtech Technologies",
  "provider": {
    "@type": "LocalBusiness",
  ...
  "serviceType": ["Laptop Repair", "Computer Repair", "Data Recovery", "Network Setup", "IT Support"],
...
export function ITSolutionsPune() {
  return (
    <div className="w-full bg-[var(--color-page)]">
      <SEO
        title="IT Solutions & Computer Repair in Pune — Coldtech Technologies"
        description="Best IT solutions company in Pune. Expert laptop repair, data recovery, network setup & IT support. Free diagnosis, transparent pricing, 30-day warranty. Call +91 95298 82920."
        keywords="IT solutions Pune, laptop repair Pune, computer repair near me Pune, data recovery Pune, network setup Pune, IT support Pune, refurbished laptops Pune, IT company Pune, computer repair services Pune"
