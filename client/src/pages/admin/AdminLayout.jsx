...
import {
  ...
  FiMenu, FiX, FiChevronLeft, FiLogOut, FiExternalLink, FiBookOpen, FiShield, FiImage,
  FiMessageSquare, FiCamera, FiDollarSign, FiFileText, FiBook, FiCreditCard, FiBarChart2,
} from 'react-icons/fi';
...
const ADMIN_NAV = [
  ...
  { to: '/admin-coldtech-secure/banners',      label: 'Banners',         icon: FiImage },
  { to: '/admin-coldtech-secure/team',         label: 'Team',            icon: FiUsers },
  { to: '/admin-coldtech-secure/testimonials', label: 'Testimonials',    icon: FiMessageSquare },
  { to: '/admin-coldtech-secure/gallery',      label: 'Work Gallery',    icon: FiCamera },
  { to: '/admin-coldtech-secure/blog',         label: 'Blog Posts',      icon: FiBookOpen },
  { to: '/admin-coldtech-secure/ai-blog',      label: '✦ AI Blog',       icon: FiZap },
  { to: '/admin-coldtech-secure/amc',          label: 'AMC Clients',     icon: FiShield },
  { to: '/admin-coldtech-secure/expenses',     label: 'Expenses',        icon: FiDollarSign },
  { to: '/admin-coldtech-secure/invoices',     label: 'Invoices',        icon: FiFileText },
  { divider: true, label: 'Accounting' },
  { to: '/admin-coldtech-secure/accounting/parties',   label: 'Parties',         icon: FiUsers },
  { to: '/admin-coldtech-secure/accounting/ledgers',   label: 'Ledgers',         icon: FiBook },
  { to: '/admin-coldtech-secure/accounting/products',  label: 'Acc. Products',   icon: FiPackage },
