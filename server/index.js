...
const workGalleryRoutes = require('./routes/workGalleryRoutes');
...
app.use('/api/work-gallery', requireDb, workGalleryRoutes);
app.use('/api/ai',           requireDb, require('./routes/aiRoutes'));
app.use('/api/expenses',     requireDb, require('./routes/expenseRoutes'));
app.use('/api/invoices',     requireDb, require('./routes/invoiceRoutes'));
app.use('/api/accounting',   requireDb, require('./routes/accountingRoutes'));
