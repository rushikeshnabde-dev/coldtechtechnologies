...
export function Contact() {
  ...
  return (
    <div className="w-full bg-[var(--color-page)]">
      <SEO
        title="Contact Us — IT Support in Pune"
        description="Contact Coldtech Technologies for IT support in Pune. Call, email, or visit us. 24/7 emergency support available. Get expert IT help today."
        keywords="contact Coldtech Technologies, IT support Pune contact, computer repair Pune phone, IT helpdesk Pune, emergency IT support Pune"
        canonical="/contact"
        schema={{
          "@context": "https://schema.org",
          "@type": "ContactPage",
          "name": "Contact Coldtech Technologies",
      ...
      <div className="relative overflow-hidden py-20 px-6 text-center"
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
          ...
          <h1 className="font-[family-name:var(--font-display)] text-4xl md:text-5xl font-bold text-white mb-3">Get in Touch</h1>
          <p className="text-cyan-300 text-lg font-medium mb-4">Have a question? Need IT support? We're here to help.</p>
